...
We are using best practice to establish a baseline banking model. Our strategy relies on the more intuitive banking systems at our disposal like BoFa, Chase or Wells Fargo.
...
5. A bank customer should be able to close an existing account (backend). (Tyfani)
6. A bank customer should be able to transfer money from one account to another (back end). (Tyfani)
...
7. Developed a rough dashboard sketch with intention of working toward a more streamlined display, psuedocode available to clarify this upon request. (Tyfani)
...
4. A checking account should allow withdrawals with overdraft protection, apply transaction fees, and support monthly maintenance fees when the account is overdrawn. (Princess)
5. A bank should allow savings accounts to handle deposits, withdrawals with a minimum balance requirement, and earn monthly interest. (Princess)
